...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeSettings) DeepCopyInto(out *VolumeSettings) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeSettings.
func (in *VolumeSettings) DeepCopy() *VolumeSettings {
	if in == nil {
		return nil
	}
	out := new(VolumeSettings)
	in.DeepCopyInto(out)
	return out
}
